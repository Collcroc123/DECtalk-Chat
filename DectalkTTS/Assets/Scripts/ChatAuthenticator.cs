...
namespace Mirror.Examples.Chat
{
    ...
    public class ChatAuthenticator : NetworkAuthenticator
    {
        ...
        {
            playerName = username;
            // Manager.instance.errorText.text = string.Empty;
            // Manager.instance.errorText.gameObject.SetActive(false);
        }
        ...
        public void OnAuthResponseMessage(AuthResponseMessage msg)
        {
            ...
            else
            {
                ...
                // Manager.instance.errorText.text = msg.message;
                // Manager.instance.errorText.gameObject.SetActive(true);
            }
        }
